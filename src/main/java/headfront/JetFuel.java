...
import headfront.guiwidgets.AlertHandler;
import headfront.guiwidgets.ConfirmHandler;
...
public class JetFuel extends Application {

    private static ConfigurableApplicationContext applicationContext;
    private static final Logger LOG = LoggerFactory.getLogger(JetFuel.class);
    public static final ImageView jetfuelImage = new ImageView(new Image("images/icons/JetFuelLarge.png"));

    public static void main(String[] args) {
        LOG.info("Starting JetFuel");
        applicationContext = SpringApplication.run(JetFuel.class, args);
        launch(args);
    }
...
//                    "};");
    ...
    public void stop() {
        try {
            ...
            Thread.sleep(1000);
            System.exit(0);
            LOG.info("JetFuel Stopped cleanly");
        } catch (Exception e) {
