...
// copied from package org.controlsfx.control.action;
...
public class ActionUtils {
     ...
     * @param textBehavior Defines {@link org.controlsfx.control.action.ActionUtils.ActionTextBehavior}
     ...
     */
    public static final Action ACTION_SEPARATOR = new Action(null, null) {
        @Override
    ...
    public static final Action ACTION_SPAN = new Action(null, null) {
        @Override
        public String toString() {
